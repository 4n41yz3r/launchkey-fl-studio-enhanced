...
native_plugin_parameter_mappings = {
    ...
    "FLEX": [
        ...
        PluginParameter(index=20, name="Filter Resonance"),
        PluginParameter(index=19, name="Filter Envelope Amount"),
        # PluginParameter(index=21, name="Master Filter Cutoff"),
        # PluginParameter(index=22, name="Master Filter Resonance"),
        # PluginParameter(index=23, name="Master Filter Type"),
        PluginParameter(index=24, name="Delay Type"),
        PluginParameter(index=25, name="Delay Mix"),
        PluginParameter(index=26, name="Delay Time"),
        PluginParameter(index=27, name="Delay Feedback"),
        PluginParameter(index=28, name="Delay Mod"),
        PluginParameter(index=29, name="Delay Color"),
        PluginParameter(index=30, name="Reverb Mix"),
        PluginParameter(index=31, name="Reverb Decay"),
        PluginParameter(index=32, name="Reverb Size"),
        PluginParameter(index=33, name="Reverb Modulation"),
        PluginParameter(index=34, name="Reverb Color"),
        PluginParameter(index=35, name="Limiter Pre"),
        PluginParameter(index=36, name="Output Volume"),
    ],
    "Harmless": [
    ...
    "MIDI Out": [
        PluginParameter(index=1, name="MIDI Out 1"),
        PluginParameter(index=2, name="MIDI Out 2"),
        PluginParameter(index=3, name="MIDI Out 3"),
        PluginParameter(index=4, name="MIDI Out 4"),
        PluginParameter(index=5, name="MIDI Out 5"),
        PluginParameter(index=6, name="MIDI Out 6"),
        PluginParameter(index=7, name="MIDI Out 7"),
        PluginParameter(index=8, name="MIDI Out 8"),
    ],
    "Morphine": [
