...
native_plugin_parameter_mappings = {
    ...
    "FLEX": [
        ...
        PluginParameter(index=2, name="Decay"),
        PluginParameter(index=3, name="Sustain"),
        PluginParameter(index=4, name="Release"),
        PluginParameter(index=5, name="Filter Attack"),
        PluginParameter(index=7, name="Filter Decay"),
        PluginParameter(index=8, name="Filter Sustain"),
        PluginParameter(index=9, name="Filter Release"),
        PluginParameter(index=18, name="Filter Cutoff"),
        PluginParameter(index=19, name="Filter Resonance"),
        PluginParameter(index=20, name="Filter Env Amount"),
        PluginParameter(index=21, name="Master Cutoff"),
        PluginParameter(index=22, name="Master Resonance"),
